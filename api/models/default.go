...
func init() {
	common.GetDB().DB().AutoMigrate(&user.BookFavorite{}, &user.BookLike{},
		...
		&user.SectionSubscription{}, &user.ShelfBook{}, &user.Shelf{},
		&user.Transaction{}, &user.User{})

	common.GetDB().DB().AutoMigrate(&book.Book{}, &book.Category{}, &book.Chapter{},
		&book.Content{}, &book.Section{}, &book.Tag{}, &book.Author{})
}
